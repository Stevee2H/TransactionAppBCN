...
# ─────────────────────────────────────────────
with tab1:
    saldo_rows    = get_saldo_per_item()
    belum_kembali = get_barang_belum_kembali()
    items_all     = get_items()
    ...
    if not df_saldo.empty:
        ...
        rincian = get_rincian_per_lantai(selected_item)
        if rincian:
